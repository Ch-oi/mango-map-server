  ...
  return knex("blogs")
    .insert([
      ...
      },
      {
        ...
        body:
          "Return to the primordial nature and zip through the jungle like a man in the wild. Embark on a special adventure combining beautiful nature and extreme sports. Get outfitted in top quality gears and embrace this once-in-a-lifetime adventure under the lead of professional guides",
        user_location_id: 5,
      },
      {
        title: "Back to Childhood",
        body:
          "At Hong Kong Disneyland, every moment is a magical one that brings you closer to your loved ones. From now to 31 August, 2020, guests can buy two 1-Day park tickets and receive an additional 1-Day ticket for free! It’s a wonderful way to share the Disney magic and happiness with all your loved ones!",
        user_location_id: 6,
      },
      {
