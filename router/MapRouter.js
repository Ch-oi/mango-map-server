...
class MapRouter {
    ...
    listAreas(req, res) {
        return this.mapService.listAreas()
    ...
    getAreaDistricts(req, res) {
        ...
        return this.mapService.getAreaDistricts(area_id)
            .then(districts => res.send(districts))
            .catch(err => console.log(err))
    }
    ...
    getDistrictUsers(req, res) {
        ...
        return this.mapService.getDistrictUsers(district_id)
            .then(districtUsers => {
    ...
    addDistrict(req, res) {
        ...
        return this.mapService.addDistrict(new_district)
